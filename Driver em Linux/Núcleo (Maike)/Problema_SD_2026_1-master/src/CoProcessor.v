module CoProcessor(
        ...
        if (rst) begin
            ...
            case(state)
                ...
                ST_MEMORY: begin //aguarda as operaçoes de escrita acontecerem
                    ...
                    // Só checa o 'done' depois de 3 ciclos de clock.
                    // Isso dá tempo para a neural_unit baixar o sinal antes de começarmos a ler.
                    if (inference_done && contador_ciclos > 24'd3) begin
    ...
    assign data_out = { contador_ciclos[23:0], 1'b0, fl_error, fl_processor_busy, fl_processor_done, predicted_digit_register };
